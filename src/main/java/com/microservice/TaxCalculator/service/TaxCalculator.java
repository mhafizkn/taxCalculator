...
public class TaxCalculator {
    ...
    private List<String> taxClaimOptions = Arrays.asList(
    ...
    public ResponseEntity<IncomeTax> calculateTax(@RequestParam(value="annualIncome", defaultValue = "1000") double annualIncome) {
        ...
        try {
            return new ResponseEntity<>(incomeTax, HttpStatus.OK);
        } catch (Exception e) {
